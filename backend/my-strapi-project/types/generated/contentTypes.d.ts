...
export interface ApiEscultorEscultor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pais: Schema.Attribute.Relation<'manyToOne', 'api::pais.pais'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEsculturaEscultura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    img_antes: Schema.Attribute.String;
    img_despues: Schema.Attribute.String;
    img_durante: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::escultura.escultura'
...
export interface ApiPaisPais extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    escultores: Schema.Attribute.Relation<
      'oneToMany',
      'api::escultor.escultor'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTematicaTematica extends Struct.CollectionTypeSchema {
