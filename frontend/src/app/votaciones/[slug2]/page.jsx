...
export default function Page() {
  ...
  const [esculturaId, codigoAdicional] = [
    ultimaParteURL.substring(0, 24),
    ultimaParteURL.substring(24),
  ];
    ...
    return (
      <>
        ...
        <div className={styles.votacionCard}>
          <div className={styles.votacionCardDatos}>
            ...
            >
              ...
              <p className={styles.votacionCardEscultor}>
                Escultor: {escultura.escultor}
              </p>
              <label className={styles.votacionCardPuntaje} htmlFor="puntaje">
                Puntaje:{" "}
              </label>
            ...
            ${index + 1 <= PuntajeVisual ? `${styles.seleccionadas}` : " "}`}
              ...
              <button className={styles.votacionCardBoton} type="submit">
                Votar
              </button>
            </form>
          </div>
