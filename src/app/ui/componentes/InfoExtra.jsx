import ImgGeneric from "./imagenGenerica.jsx";
import predio from "/public/plano-predio.jpg";
  ...
  return (
    <>
      <header>
        <nav className="menu">
          <ul className="enlaces">
            <li>
              <a href="#info" className="enlace__info">
                {" "}
                Información{" "}
              </a>
            </li>
            <li>
              <a href="#map" className="enlace__map">
                {" "}
                Mapa{" "}
              </a>
            </li>
            <li>
              <a href="#predio" className="enlace__predio">
                {" "}
                Predio{" "}
              </a>
            </li>
      ...
      <div className="predio" id="predio">
        ...
        <ImgGeneric titulo="Predio" imagen={predio} dimensions="500" />
      </div>
    </>
  );
}
