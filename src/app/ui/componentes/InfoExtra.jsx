...
export default function InfoExtra () {
    ...
    return (
        <>
                    ...
                    <ul className="enlaces">
                        <li>
                            <a 
                                ...
                                onClick={() => setActive("info")}> Información 
                            </a>
                        </li>
                        <li>
                            <a 
                        ...
                        <li>
                            <a 
                                ...
                                onClick={() => setActive("predio")}> Predio 
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <div className={`info ${active === "info" ? "visible" : "oculto"}`} id="info">
            ...
            <div className={`mapResponsive ${active === "map" ? "visible" : "oculto"}`} id="map">
                <iframe
            ...
            <div className={`predio ${active === "predio" ? "visible" : "oculto"}`} id="predio">
                {/*Acá solo qeudaría agregar la imagen del predio que esta en el canva*/}
                <ImagenArte
