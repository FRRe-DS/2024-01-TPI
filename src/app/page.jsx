  ...
  return (
    <>
      <main className={styles.rootMain}>
        ...
        <div className={styles.rootTituloTexto1}>
          <div className={styles.column}>
            ...
            <p className={styles.rootTexto}>
              Los artistas, seleccionados a nivel internacional, trabajan durante
              aproximadamente una semana en sus esculturas. Estas obras suelen
              estar hechas de materiales duraderos, como piedra, metal, mármol,
              madera, entre otros. El público tiene la oportunidad de observar
              cómo las ideas toman forma en tiempo real, lo que convierte el
              evento en una experiencia educativa y dinámica.
            </p>
            <p className={styles.rootTituloTexto}>Exposición permanente</p>
            <p className={styles.rootTexto}>
              Resistencia es conocida como la "Ciudad de las Esculturas" debido a
              la gran cantidad de obras que la adornan. Muchas de las esculturas
              creadas en las ediciones anteriores de la bienal pasan a formar
              parte de esta exposición permanente al aire libre. Actualmente, hay
              más de 600 esculturas distribuidas por toda la ciudad, lo que
              convierte a Resistencia en un verdadero museo a cielo abierto.
            </p>
          </div>
          <div className={styles.column}>
            <p className={styles.rootTituloTexto}>
            ...
            <p className={styles.rootTexto}>
              ...
              para el público. Estos espacios están diseñados tanto para artistas
              profesionales como para aficionados y estudiantes. La comunidad
              local, en particular, se involucra activamente, lo que refuerza el
              sentido de pertenencia y la apreciación del arte.
            </p>
            ...
            <p className={styles.rootTexto}>
              ...
              relacionadas con cuestiones actuales como la identidad cultural, la
              naturaleza, la historia local o problemas sociales globales. Estas
              temáticas permiten que los artistas aborden temas relevantes desde
              una perspectiva artística, generando una reflexión en los
              espectadores.
            </p>
          </div>
        </div>
